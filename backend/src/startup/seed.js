...
export async function seedFieldConfigsIfEmpty() {
  const count = await FieldConfig.countDocuments({ tenantId: DEMO_TENANT_ID });
  if (count > 0) return;
  ...
  console.log(`✅ Auto-seeded ${fields.length} field configurations`);
}
